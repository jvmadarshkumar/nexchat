    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500 selection:text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-4xl font-extrabold text-white tracking-tight">Flexible Plans Built for Everyone</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 flex flex-col justify-between hover:border-slate-700 transition-all">
            <div>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-xl font-bold text-slate-100">Free Community</h3>
                <span className="px-3 py-1 rounded-full bg-slate-800 text-slate-300 text-xs font-semibold">Forever Free</span>
              </div>
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-extrabold text-white">$0</span>
                <span className="text-slate-400 text-sm">/ month</span>
              </div>
              <p className="text-slate-400 text-sm mb-6">Ideal for public communities, student groups, and individual collaborators.</p>
            ...
            <Link
              to="/login"
              className="w-full text-center py-3.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-semibold text-sm transition-colors block">
              Get Started Free
            </Link>
          </div>

          {/* Card 2: Pro Workspace (Featured) */}
          <div className="p-8 rounded-3xl bg-slate-900/90 border-2 border-indigo-500/80 relative flex flex-col justify-between shadow-2xl shadow-indigo-500/20 scale-105">
            ...
            <div>
              <div className="flex items-center justify-between mb-4 mt-2">
                <h3 className="text-xl font-bold text-white">Pro Workspace</h3>
              ...
              <p className="text-slate-400 text-sm mb-6">Built for growing teams, companies, and institutional departments.</p>
          ...
          <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 flex flex-col justify-between hover:border-slate-700 transition-all">
            <div>
              ...
              <p className="text-slate-400 text-sm mb-6">For large universities, enterprises, and custom cloud deployments.</p>
